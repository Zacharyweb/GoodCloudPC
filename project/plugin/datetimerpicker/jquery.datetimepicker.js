...
(function ($) {
    ...
    $.fn.datetimepicker = function (opt) {
        var KEY0 = 48,
			...
			createDateTimePicker = function (input) {
			    var datetimepicker = $('<div ' + (options.id ? 'id="' + options.id + '"' : '') + ' ' + (options.style ? 'style="' + options.style + '"' : '') + ' class="xdsoft_datetimepicker xdsoft_noselect ' + options.className + '"></div>'),
					xdsoft_copyright = $('<div class="xdsoft_copyright"><a target="_blank" href="http://6188.hk">xdsoft</a></div>'),
					datepicker = $('<div class="xdsoft_datepicker active"></div>'),
					mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><button type="button" class="banana_clear_button glyphicon glyphicon-trash"></button><div class="xdsoft_label xdsoft_month"><span></span></div><div class="xdsoft_label xdsoft_year"><span></span></div><button type="button" class="xdsoft_next"></button></div>'),
			    ...
			    //<button type="button" class="banana_clear_button glyphicon glyphicon-trash"></button>
			    //constructor lego
			    mounth_picker
			    ...
			    mounth_picker.find('.xdsoft_today_button')
			    ...
			    mounth_picker.find('.banana_clear_button')
						.on('mousedown.xdsoft', function () {
						    input.val(_xdsoft_datetime.empty());
						    datetimepicker.trigger('close.xdsoft');
						});
			    ...
			    calendar.on('click.xdsoft', 'td', function () {
			        ...
			        //选择前
			        if (options.BeforeSelectData) {
			            var bol = options.BeforeSelectData(datetimepicker, _xdsoft_datetime.currentTime, _xdsoft_datetime.str(), input);
			            if (!bol) {
			                return false;
			            }
			        }
			    ...
			    timebox.on('click.xdsoft', 'div', function () {
			        ...
			        //选择前
			        if (options.BeforeSelectData) {
			            var bol = options.BeforeSelectData(datetimepicker, _xdsoft_datetime.currentTime, _xdsoft_datetime.str());
			            if (!bol) return false;
			        }
        ...
        var returnInput = this.each(function () {
            var datetimepicker;
        ...
        if (options.readonly) {
            return returnInput.attr("readonly", "readonly");
        }
        return returnInput;
    };
})(jQuery);
