...
var GoodsClass = function() {
    ...
    var loader = {
        ...
        addFirstClass:function(params,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/editFirst"),
                data: params,
                dataType: "json",
                success: function(result) {
                    callback(result);
        ...
        singleFirst:function(id,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/singleFirst"),
                data: {
                    id:id
                },
                dataType: "json",
        ...
        firstClassUpDown:function(params,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/switchFirst"),
                data: params,
                dataType: "json",
                success: function(result) {
                    callback(result)
        ...
        delFirst:function(id,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/delFirst"),
                data: {
                    id:id
                },
                dataType: "json",
        ...
        editSecond:function(params,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/editSecond"),
                data:params,
                dataType: "json",
                success: function(result) {
                    callback(result);
        ...
        singleSecond:function(id,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/singleSecond"),
                data: {
                    id:id
                },
                dataType: "json",
        ...
        delSecond:function(id,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/delSecond"),
                data: {
                    id:id
                },
                dataType: "json",
        ...
        switchSecond:function(params,callback){
            $.ajaxAuthor({
                type: "post",
                url: urlFunc.format("goodCate/switchSecond"),
                data: params,
                dataType: "json",
                success: function(result) {
                    callback(result)
        ...
        uiEvent: function() {
                ...
                if(!title){
                    ...
                    loader.addFirstClass(params,function(result){
                        ...
                        if(result.statusCode == 0){
                            toastr.success('添加一级分类成功');
                            $("#addDirectory1").modal("hide");
                            loader.loadDataFirst();
                        }else{
                            toastr.warning("添加一级分类失败!");
                        }
                    });
                }
            });
            ...
            $("body").on("click",".massagRevise",function () {
                ...
                loader.singleFirst(id,function (result) {
                    $("#addBrandForm1 .className").val(result.data.name);
                });
             });
            $("#xiuGai").on("click",function(){
                ...
                if(!title){
                    ...
                    loader.addFirstClass(params,function(result){
                        if(result.statusCode == 0){
                            toastr.success('修改一级分类成功');
                            $("#addDirectory1").modal("hide");
                            loader.loadDataFirst();
                        }else{
                            toastr.warning("修改一级分类失败!");
                        }
                    });
                }
            ...
            $("body").on("click",".firstMoveUp",function () {
                ...
                loader.firstClassUpDown(params,function (result) {
                    if(result.statusCode== 0){
                        loader.loadDataFirst();
                        toastr.success("一级分类上移成功");
                    }else{
                        toastr.warning("一级分类上移失败")
                        return
                    }
                });
            ...
            $('body').on('click','.move_edit',function () {
                ...
                loader.singleSecond(id,function (result) {
                    $("#sTitle").val(result.data.name)
                });
                loader.singleFirst(fid,function (result) {
                    $("#sClass").val(result.data.name)
                })
            });
